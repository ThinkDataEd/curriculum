...
###**Materials:**
1. *Friend Network Graphic* ([LMR_U4_L19_A](../IDS_Curriculum_v_5.0/2_IDS_LMRs_v_6.0/IDS_LMR_Unit 4_v_6.0/LMR_U4_L19_A.pdf))

2. Index cards

3. *Network Code* file ([LMR_U4_L19_B](../IDS_Curriculum_v_5.0/2_IDS_LMRs_v_6.0/IDS_LMR_Unit 4_v_6.0/LMR_U4_L19_B))
...
7. Once all data has been input into a spreadsheet, use the code provided in the *Network Code* file ([LMR_U4_L19_B](../IDS_Curriculum_v_5.0/2_IDS_LMRs_v_6.0/IDS_LMR_Unit 4_v_6.0/LMR_U4_L19_B)) to produce graphs for the class’s social network.
