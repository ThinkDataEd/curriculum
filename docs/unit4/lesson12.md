...
7. Distribute the 3 plots from the *Advertising Plots Part 1* handout ([LMR_4.12](../IDS_Curriculum_v_5.0/2_IDS_LMRs_v_5.0/IDS_LMR_Unit 4_v_5.0/LMR_4.12_Advertising Plots 1.pdf)) and inform the students about the data using the details below:
...
12. Distribute the *Advertising Plots Part 2* handout ([LMR_4.13_Advertising Plots 2](../IDS_Curriculum_v_5.0/2_IDS_LMRs_v_5.0/IDS_LMR_Unit 4_v_5.0/LMR_4.13_Advertising Plots 2.pdf)), which contains plots A-C, but now include the line of best fit.
