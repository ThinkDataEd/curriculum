...
2. Distribute the Landfill Article handout ([LMR_4.15_Landfill Article](../IDS_Curriculum_v_5.0/2_IDS_LMRs_v_5.0/IDS_LMR_Unit 4_v_5.0/LMR_4.15_Landfill Article.pdf)) and explain that the reading is an excerpt from a CNN article titled *Trash City: Inside America’s Largest Landfill Site*. The article will set the context for the real-world problem of growing landfills.
...
4. After they have finished reading, students should answer the questions provided on the *Landfill Readiness Questions* handout ([LMR_4.16_Landfill Readiness Questions](../IDS_Curriculum_v_5.0/2_IDS_LMRs_v_5.0/IDS_LMR_Unit 4_v_5.0/LMR_4.16_Landfill Readiness Questions.pdf)). Then, in teams, students will discuss their insights, questions, and/or reactions to the both the article and the questions. Follow up the team discussion with a class discussion to gauge what students actually know about trash and recycling.
...
11. To assist students’ interaction with the dashboard, distribute the *Trash Dashboard Exploration* handout ([LMR_4.18_Trash Data Exploration](../IDS_Curriculum_v_5.0/2_IDS_LMRs_v_5.0/IDS_LMR_Unit 4_v_5.0/LMR_4.18_Trash Data Exploration.pdf)).
